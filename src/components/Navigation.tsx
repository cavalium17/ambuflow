...
const Navigation: React.FC<NavigationProps> = React.memo(({ activeTab, setActiveTab, darkMode = false }) => {
  const tabs = [
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`flex-1 relative h-full flex flex-col items-center justify-center gap-1 transition-all duration-300 outline-none ${
                isActive 
                ? 'text-indigo-500' 
