...
import { getFrenchPublicHolidays, isSundayOrHoliday } from '../utils/dateUtils';
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-black tracking-tight">{shift.start} <span className="text-[10px]">—</span> {shift.end}</p>
                      </div>
                    </div>
...
const PaieTab: React.FC<PaieTabProps> = React.memo(({ 
  darkMode = false, 
  hasTaxiCard = false, 
  hourlyRate, 
  hoursBase, 
