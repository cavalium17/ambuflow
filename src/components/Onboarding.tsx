        ...
        <div className="flex-1 flex flex-col justify-center animate-fadeIn py-8">
          <div key={step} className="animate-slideUp">
            ...
            {step === 4 && (
              <div className="space-y-8">
                <div className="space-y-2">
                  <h2 className="text-4xl font-black tracking-tighter text-white">Détails de Paie</h2>
                  <p className="text-slate-300 text-lg font-medium">Configurez votre environnement.</p>
                </div>
                <div className="space-y-4">
                  <div className="relative group">
                    <Building2 className="absolute left-4 top-1/2 -translate-y-1/2 text-indigo-500" size={20} />
                    <input 
                      type="text" 
                  ...
                  <div className="relative group">
                    <Phone className="absolute left-4 top-1/2 -translate-y-1/2 text-indigo-500" size={20} />
                    <input 
                      type="tel" 
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-2">
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-black text-indigo-300 uppercase tracking-[0.2em] px-1 mb-1 block">Taux Horaire (€)</label>
                      <input 
                        type="number" 
                        step="0.01" 
                        className={inputBaseClass + " text-sm py-2.5 px-4 h-[44px]"} 
